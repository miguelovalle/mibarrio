  ...
  const getCoord = () => {
    if (position) {
      ...
      setshowAlert({
        show: true,
        message:
          "Autorice captura de posicion o registrese como nuevo usuario para mostrarle nuestro comercio",
      });
    }
  };
    ...
    <Box>
      <Flex direction="column" align="center">
        ...
        <VStack>
          ...
          <Button as="a" colorScheme="blue" w="sm" p="6" mt="4" href="/login">
            Ingresar. Ya estoy registrado
          </Button>
        </VStack>
      </Flex>
    </Box>
